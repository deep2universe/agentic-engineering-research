...
![Skills Zero to Hero — Guide-Struktur](images/szh-00_guide_uebersicht.png)
...
| Nr. | Dokument | Inhalt |
|-----|----------|--------|
| 01 | [Grundlagen: Was sind Skills?](SZH-01-Grundlagen-Skills) | Definition, Abgrenzung, Einordnung im Agentic Engineering |
| 02 | [Der Agent Skills Standard](SZH-02-Agent-Skills-Standard) | Offener Standard, Spezifikation, Cross-Platform-Adoption |
| 03 | [Anatomie eines Skills](SZH-03-Skill-Anatomie) | SKILL.md, Frontmatter, Verzeichnisstruktur, Lebenszyklus |
| 04 | [Prinzipien für Skill-Design](SZH-04-Skill-Prinzipien) | Kernprinzipien, Conciseness, Progressive Disclosure, Freedom Levels |
| 05 | [Design Patterns für Skills](SZH-05-Skill-Patterns) | Template, Workflow, Conditional, Feedback-Loop, Composition Patterns |
| 06 | [Skills planen und erstellen](SZH-06-Skill-Planung-Erstellung) | Methodik, Evaluation-Driven Development, iterativer Prozess |
| 07 | [Skills in Claude Code](SZH-07-Claude-Code-Skills) | Bundled Skills, Custom Skills, Invocation, Subagents, Hooks |
| 08 | [Skill-Ökosystem und Frameworks](SZH-08-Skill-Oekosystem) | MCP, Agent Skills Standard, Plattformen, Cross-Tool-Kompatibilität |
| 09 | [Fortgeschrittene Patterns](SZH-09-Advanced-Patterns) | Dynamic Context Injection, Shell Preprocessing, Multi-Agent Skills |
| 10 | [Anti-Patterns und Fallstricke](SZH-10-Anti-Patterns) | Häufige Fehler, Security-Risiken, Performance-Fallen |
| 11 | [Wissenslandkarte](SZH-11-Skill-Landkarte) | Vollständige Landkarte aller Wissenspunkte zu Skills |
