...
![Executive Summary — 10 Kernerkenntnisse](images/ptj-executive_summary_kernerkenntnisse.png)
...
![Abgrenzung COBOL-Research vs. PL/I-Research](images/ptj-abgrenzung_cobol_pl1_delta.png)
...
![Decision Framework Flussdiagramm](images/ptj-decision_framework_flussdiagramm.png)
...
![Navigation Research-Hub](images/ptj-navigation_research_hub.png)

*Hub-and-Spoke-Karte der gesamten Research: Der Hauptguide im Zentrum, die acht Fachdokumente als Satelliten mit Inhalts-Sneak-Peek, dazu [_quellen](PTJ-Quellen) als persistente Belegstelle. Farbcode pro Dokument zur schnelleren Wiedererkennung.*

| Du moechtest ... | Lies ... |
|------------------|---------|
| ... einen Gesamtueberblick (du bist hier) | [pl1_zu_java_hauptguide](PTJ-00-Hauptguide) |
| ... PL/I-Sprachfeatures und deren Java-Mapping verstehen | [pl1_sprachmerkmale_und_konvertierung](PTJ-01-Sprachmerkmale) |
| ... wissen, welche AWS-Services in welcher Phase relevant sind | [aws_feature_uebersicht_fuer_pl1](PTJ-02-AWS-Features) |
| ... die agentic-AI-Workflows konkret umsetzen | [agentic_engineering_workflows](PTJ-03-Agentic-Workflows) |
| ... ein 50-Prozent-Projekt retten oder weiterfuehren | [migration_50_prozent_szenarien](PTJ-04-50-Prozent-Szenarien) |
| ... eine belastbare Teststrategie bauen | [testabdeckung_und_teststrategien](PTJ-05-Teststrategien) |
| ... Fallstricke und Patterns kennen | [best_practices_pl1](PTJ-06-Best-Practices) |
| ... deinen Loesungshorizont erweitern | [loesungshorizont_erweitert](PTJ-07-Loesungshorizont) |
| ... alle Quellen nachlesen | [_quellen](PTJ-Quellen) |

---

## 5. Kernaussagen fuer Management

![Drei Saeulen fuer Management](images/ptj-management_drei_saeulen_erfolg.png)
...
![Scope-Abgrenzung des Guides](images/ptj-scope_abgrenzung_guide.png)
...
![Onboarding-Roadmap ueber vier Wochen](images/ptj-onboarding_roadmap_wochen.png)
...
1. **Tag 1–2:** Lies dieses Hauptdokument und [pl1_sprachmerkmale_und_konvertierung](PTJ-01-Sprachmerkmale).
2. **Tag 3–5:** Studiere [aws_feature_uebersicht_fuer_pl1](PTJ-02-AWS-Features) und teste parallel einen Blu Age Developer-Setup auf AppStream 2.0 mit dem PlanetsDemo-Sample.
3. **Woche 2:** Baue auf Basis von [agentic_engineering_workflows](PTJ-03-Agentic-Workflows) eine erste Assessment-Pipeline.
4. **Woche 3:** Entwickle mit [testabdeckung_und_teststrategien](PTJ-05-Teststrategien) deine projektspezifische Teststrategie.
5. **Woche 4+:** Nutze [best_practices_pl1](PTJ-06-Best-Practices) und [loesungshorizont_erweitert](PTJ-07-Loesungshorizont) als fortlaufende Referenz.

Wenn dein Projekt bereits bei ca. 50 % ist: starte mit [migration_50_prozent_szenarien](PTJ-04-50-Prozent-Szenarien).

---

## 8. Disclaimer

![Quellen als Fundament der Research](images/ptj-disclaimer_quellen_fundament.png)
