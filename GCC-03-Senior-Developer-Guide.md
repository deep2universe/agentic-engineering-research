---
title: "03 Senior Developer Guide"
...
> Stand: 2026-04-06 · Voraussetzung: [installations_und_setup_guide](GCC-02-Installation-und-Setup) gelesen
...
![Mentales Modell – Agent-Schleife](images/gcc-sen_mentales_modell.png)
...
![Context Engineering – 4 Säulen](images/gcc-sen_context_engineering.png)
...
![Sicherheits-Mindset – Regeln & Failure Modes](images/gcc-sen_sicherheits_mindset.png)
...
![Patterns für die tägliche Arbeit](images/gcc-sen_patterns_taeglich.png)
...
![CI/CD-Integration](images/gcc-sen_cicd_integration.png)
...
![CLI-Agents Vergleich](images/gcc-sen_vergleich_cli_agents.png)
...
Vollständig in [workflows_und_vergleich](GCC-05-Workflows-und-Vergleich).

## 7. Reife-Stufen für ein Team

![Reife-Stufen – Treppe](images/gcc-sen_reife_stufen.png)
...
![Top 10 Empfehlungen](images/gcc-sen_top10_architekten.png)
...
Weiterführend: [cheat_sheet](GCC-06-Cheat-Sheet) (täglicher Spickzettel), [agentic_engineering_mcp_security](GCC-04-Agentic-MCP-Security) (tiefer Sicherheits-Drill-Down), [workflows_und_vergleich](GCC-05-Workflows-und-Vergleich) (Tool-Vergleich, CI/CD).
