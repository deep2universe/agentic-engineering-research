---
title: "05 Testabdeckung und Teststrategien"
...
![Warum Testing der Engpass in PL/I-Migrationen ist](images/ptj-warum_testing_engpass.png)
...
![Test-Pyramide fuer PL/I-zu-Java](images/ptj-test_pyramide_pl1_java.png)
...
![Unit-Tests — Generierung und Struktur](images/ptj-unit_tests_struktur.png)
...
![Property-Based Testing mit jqwik](images/ptj-property_based_testing.png)
...
![Dual-Run und Golden Master](images/ptj-dual_run_golden_master.png)
...
![Integration-Tests — Scope und Werkzeuge](images/ptj-integration_tests_scope.png)
...
![End-to-End und Shadow-Tests](images/ptj-e2e_shadow_tests.png)
...
![Mutation Testing mit PIT](images/ptj-mutation_testing_pit.png)
...
![Test-Daten-Management Lifecycle](images/ptj-test_daten_management.png)
...
![FIXED-DECIMAL-Teststrategie](images/ptj-fixed_decimal_teststrategie.png)
...
![Testing in der CI/CD-Pipeline](images/ptj-cicd_testing_pipeline.png)
...
![KPIs fuer PL/I-Testing](images/ptj-testing_kpis.png)
...
![Vier Rollen im Test-Team](images/ptj-rollen_test_team.png)
...
![Agentic Testing Staerken und Schwaechen](images/ptj-agentic_testing_staerken_schwaechen.png)
...
![Quellen-Cluster fuer Dokument 6](images/ptj-referenzen_testing_quellen.png)

*Sechs Quellen-Cluster: Unit+Property Testing, Dual-Run+Golden Master, Integration+E2E, Mutation Testing, Test-Daten-Management, Shadow Traffic+Chaos. ~70 oeffentliche Quellen, 18 Suchstring-Gruppen in [_quellen](PTJ-Quellen).*
