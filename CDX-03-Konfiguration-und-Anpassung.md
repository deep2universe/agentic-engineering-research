---
title: "03 Konfiguration und Anpassung"
parent: "Codex CLI"
nav_order: 4
---
...
![Sechsstufiger Precedence-Stack von CLI-Flags bis Built-in Defaults als Schichttorte](images/cdx-konfig_01_config_precedence.png)
...
![Top-Level-Keys als Schaltpult mit Gruppen für Modell, Sicherheit, Doku, Telemetrie und Experimentelles](images/cdx-konfig_02_top_level_keys.png)
...
![Fünf Profile daily, planning, review, local und ci als Umschalt-Karten mit Aktivierungsweg](images/cdx-konfig_03_profile.png)
...
![Provider-Galaxie mit Codex im Zentrum und OpenAI, Azure, Anthropic, OpenRouter, Morph, Ollama und LM Studio als Satelliten](images/cdx-konfig_04_model_providers.png)
...
![MCP-Server-Stanza als Steckleiste mit Feldern und per-Tool-Kippschaltern für Approval-Modes](images/cdx-konfig_05_mcp_server.png)
...
![Klimakapsel-Sandbox mit Default-Writeable-Pfaden, zusätzlichen writable_roots und verschlossener Netz-Tür](images/cdx-konfig_06_sandbox_workspace_write.png)
...
![Vierstufige Filter-Siebbatterie für Env-Variablen mit inherit, exclude, include_only und set](images/cdx-konfig_07_shell_env_policy.png)
...
![Werkzeugregal mit web_search, apply_patch, view_image und shell inklusive Config-Reglern und max_output_bytes](images/cdx-konfig_08_tools_block.png)
...
![Event-Telegraph vom agent-turn-complete über Script und stdin-JSON-Payload zu Slack, Desktop und CI](images/cdx-konfig_09_notify_hook.png)
...
![Terminal-Cockpit mit History-Persistence, max_bytes-Rolling und TUI-Optionen für Theme, Mouse und Token-Usage](images/cdx-konfig_10_history_tui.png)
...
![Trusted-Tresor mit Siegel und untrusted-Regal durchgestrichen zeigt Laden oder Ignorieren der Repo-Config](images/cdx-konfig_11_projects_trust.png)
...
![Steckdosenleiste mit beschrifteten Env-Var-Karten gruppiert nach Auth, Pfaden, TLS und Logging](images/cdx-konfig_12_env_vars.png)
...
![Leuchtturm mit AGENTS.md-Sektionen, Precedence-Hierarchie und 32-KiB-Limit](images/cdx-konfig_13_agents_md.png)
...
![Baukasten-Regal mit expliziten Slash-Commands aus prompts-Ordner und impliziten Shared Skills via SKILL.md-Description](images/cdx-konfig_14_custom_prompts_skills.png)
...
Skill-Verzeichnis im Repo (z. B. `skills/release/SKILL.md`), ausgewählt automatisch, wenn der Task zur `description` passt. Siehe [feature_uebersicht](CDX-02-Feature-Uebersicht) §6.2.

## 15. Logging & Debugging

![Observability-Turm mit Log-Streams aus codex.log, Sessions-JSONL, RUST_LOG, -v und CODEX_MCP_LOG](images/cdx-konfig_15_logging_debugging.png)
...
![Annotierter Blueprint der config.toml mit Sektions-Beschriftungen am Rand für alle acht Hauptblöcke](images/cdx-konfig_16_full_sample_config.png)
