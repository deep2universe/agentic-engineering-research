...
Diese Seite listet **alle wesentlichen Features** der Codex CLI in thematischen Gruppen mit Flag, Slash-Command oder Config-Key. Für Konfigurations-Details siehe [konfiguration_und_anpassung](CDX-03-Konfiguration-und-Anpassung), für Sicherheits-Features [sicherheit_und_sandboxing](CDX-04-Sicherheit-und-Sandboxing).

## 1. Laufmodi

![Sieben Laufmodi der Codex CLI als Mode-Dial-Panel-Grid: Interactive TUI, Headless Exec, Resume, Cloud Handoff, MCP Server, Review, Completion](images/cdx-feature_uebersicht_01_laufmodi.png)
...
![Eingabe-Pipelines als Trichter: Inline-Prompt, Prompt-Datei, Image, Drag-and-Drop, @-Mention, Skill-Trigger](images/cdx-feature_uebersicht_02_eingabe_modi.png)
...
![Sechzehn Slash-Commands gruppiert nach Session, Modell/Policy, Workflow und Utilities als Kommando-Tafel mit Slash-Dial](images/cdx-feature_uebersicht_03_slash_commands.png)
...
![CLI-Flags als DIP-Switch-Matrix gruppiert nach Modell/Profil, Sandbox/Approval, Output, Modus und Debug](images/cdx-feature_uebersicht_04_kommandozeilen_flags.png)
...
![Session-Timeline mit Compaction, Resume und History als Akkordeon: Turns werden zu kompakter Summary gefaltet, Reverse-Search erschliesst alte Prompts](images/cdx-feature_uebersicht_05_kontext_session.png)
...
![Drei Artefakttypen als Plugin-Regal: Custom Slash-Commands, Agent Skills mit implicit invocation, Marketplace-Bundles](images/cdx-feature_uebersicht_06_custom_prompts_skills.png)
...
![Werkzeuggürtel des Codex-Agenten mit acht Tool-Kategorien: File R/W/E, Shell Exec, Web Search, View Image, Apply Patch, Plan Mode, MCP Tools, Custom Tools](images/cdx-feature_uebersicht_07_tools.png)
...
![Codex-Cockpit: Modell-Wähler mit Default gpt-5.3-codex, Reasoning-Effort-Dial low/medium/high, Preamble-Beispiel und Phase-Parameter-Hinweis](images/cdx-feature_uebersicht_08_modelle_reasoning.png)
...
![Stilisiertes TUI-Mockup mit Chat-Panel, Thinking-Panel, Diff-Anzeige, Composer, Status-Bar, Notification-Badge und Theme-Hinweis](images/cdx-feature_uebersicht_09_tui_features.png)
...
![IDE-Mockup der Codex-Extension: Side-Panel-Chat, Inline-Approval, Task-Tracker mit PR-Badges, Diff-Preview und Continue-in-Cloud-Button](images/cdx-feature_uebersicht_10_ide_extension.png)
...
Details in [integrationen_ide_ci_cd](CDX-05-Integrationen-IDE-CI-CD).

## 11. MCP-Integration

![MCP-Integration bidirektional: Codex als Client bindet fremde MCP-Server ein, als Server via codex mcp serve exponiert er sich andere Agenten, mit Per-Tool-Approval](images/cdx-feature_uebersicht_11_mcp_integration.png)
...
![Vier Arme der Codex-GitHub-Integration: codex-action@v1, Codex Review App, Autofix via workflow_run und Issue-to-PR-Flow über Cloud-Tasks](images/cdx-feature_uebersicht_12_github_integration.png)

- **openai/codex-action@v1** (GitHub Action) — siehe [integrationen_ide_ci_cd](CDX-05-Integrationen-IDE-CI-CD).
...
![Notify-Hook als Signallampe mit JSON-Payload-Feldern status, title, summary, duration, url, last_assistant_message und drei Konsumenten-Beispielen (Slack, Desktop, Mail)](images/cdx-feature_uebersicht_13_notify_hooks.png)

`notify`-Hook wird bei `agent-turn-complete` aufgerufen. Script erhält JSON auf stdin: `status`, `title`, `summary`, `duration`, `url`, `last_assistant_message`. Beispiele in [integrationen_ide_ci_cd](CDX-05-Integrationen-IDE-CI-CD) §6.

## 14. Provider-Pluralität

![Codex-Hub mit Speichen zu neun Providern: OpenAI, Azure, Anthropic, Gemini, OpenRouter, Mistral, Morph, Ollama, LM Studio, unterteilt nach Wire-API responses vs. chat](images/cdx-feature_uebersicht_14_provider_pluralitaet.png)
...
![Tacho-Dashboard für Kostenkontrolle: Rate-Limit-Tacho, codex-usage-Output, ZDR-Switch, Session-Log-Pfade und OpenTelemetry-Pipeline](images/cdx-feature_uebersicht_15_kostenkontrolle_telemetrie.png)
...
![Labor-Tisch mit neun Experiment-Flaschen: Plan-Mode, Realtime-Start-Instructions, RMCP-Client, Codex-Spark, Devcontainer via bwrap, Marketplace, Reverse-Search, Phase-Parameter, MCP-Apps, mit Stabilitätsampel je Feature](images/cdx-feature_uebersicht_16_experimentelle_features.png)
...
![Keyboard-Diagramm mit hervorgehobenen Codex-Tasten Ctrl+C, Ctrl+D, Tab, Shift+Tab, Ctrl+R, Pfeile, Esc, @, / und Cmd/Ctrl+F, mit Referenz-Liste rechts](images/cdx-feature_uebersicht_17_tastatur_shortcuts.png)
...
![Stellwerks-Dashboard als Feature-mal-Aktivierung-Matrix mit Spalten CLI-Flag, Slash-Command, config.toml, Environment-Variable für zwölf Features](images/cdx-feature_uebersicht_18_mini_matrix.png)
...
- [cheat_sheet](CDX-10-Cheat-Sheet)
