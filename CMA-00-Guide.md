---
title: "00 Guide und Decision Framework"
...
![Executive Summary](images/cma-guide_01_executive_summary.png)
...
![Reading Guide](images/cma-guide_02_reading_guide.png)
...
2. [best_practices_und_patterns](CMA-05-Best-Practices) (besonders Sektion 1: Migrationsstrategie)
3. [cobol_migration_weitere_tools](CMA-06-Weitere-Tools) (Anbieter-Vergleichsmatrix)
4. [aws_mainframe_modernization_deep_dive](CMA-01-AWS-Mainframe-Modernization) und [aws_transform_deep_dive](CMA-02-AWS-Transform)

### Fuer den **Senior Developer**, der die Tools verstehen will:
1. [cobol_to_java_aws_migrationsguide](CMA-04-COBOL-zu-Java) (End-to-End Workflow)
2. [aws_transform_deep_dive](CMA-02-AWS-Transform) (KI-Tools im Detail)
3. [aws_mainframe_modernization_deep_dive](CMA-01-AWS-Mainframe-Modernization) (Runtime-Details)
4. [best_practices_und_patterns](CMA-05-Best-Practices) (Sektion 2: Technische Best Practices)

### Fuer den **Projektleiter / Migration Manager**:
1. Dieses Dokument (Decision Framework)
2. [aws_migration_hub](CMA-03-AWS-Migration-Hub) (Wave Planning, Phasen)
3. [best_practices_und_patterns](CMA-05-Best-Practices) (Fallstricke, Risiken)
4. [cobol_to_java_aws_migrationsguide](CMA-04-COBOL-zu-Java) (Phasen 1-2, 7-8)

### Fuer den **CTO / Entscheider**:
1. Dieses Dokument (Executive Summary)
2. [cobol_migration_weitere_tools](CMA-06-Weitere-Tools) (Anbieter-Vergleich, Empfehlungen)
3. [best_practices_und_patterns](CMA-05-Best-Practices) (Sektion 1.4: TCO-Analyse, Sektion 4: Fallstricke)

---

## 3. Decision Framework

![Decision Framework](images/cma-guide_03_decision_framework.png)
...
![AWS Tool Landschaft 2026](images/cma-guide_04_aws_tool_landschaft.png)
...
![Risiko-Matrix](images/cma-guide_05_risiken_matrix.png)
...
![Strategische Roadmap](images/cma-guide_06_strategische_roadmap.png)
...
![AWS Referenzen](images/cma-guide_07_referenzen.png)

Alle Quellen dieser Research sind in [_quellen](CMA-Quellen) gepflegt. Die wichtigsten offiziellen AWS-Quellen:
...
![Schlussbemerkung](images/cma-guide_08_schlussbemerkung.png)
