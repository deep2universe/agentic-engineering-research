---
title: "01 Installation und Setup"
parent: "Codex CLI"
nav_order: 2
---
...
![Kernmerkmale von Codex CLI (Agent-Loop, Kernel-Sandbox, Multi-Provider, Open Source) mit Abgrenzung zu Claude Code, Copilot CLI, Aider, Cursor und Gemini CLI](images/cdx-installation_und_setup_01_was_ist_codex.png)
...
![Horizontale Timeline von 04/2025 bis 04/2026 mit 12 farbkodierten Meilensteinen: erstes CLI-Release, Codex-Cloud, Rust-Rewrite, GPT-5-Codex bis GPT-5.3, Enterprise-Features, v0.121.0](images/cdx-installation_und_setup_02_kurz_historie.png)
...
![Vier parallele Installations-Lanes (npm, Homebrew, Pre-built Binaries, Cargo) münden in ein einzelnes Rust-Binary; rechts die Systemvoraussetzungen](images/cdx-installation_und_setup_03_installation.png)
...
![Drei Auth-Pfade (ChatGPT-OAuth, OpenAI API-Key, Third-Party-Provider) münden in eine Codex-Session; mit Rate-Limit-Tabelle, Warn-Box zum API-Key-Override und Auth-/State-Dateien](images/cdx-installation_und_setup_04_authentifizierung.png)
...
![Modell-Hierarchie als Fuhrpark: GPT-5.3-Codex als Default, Kernreihe 5.x, Legacy (o3, o4-mini, gpt-4.1) und Third-Party (Claude, Gemini, OSS); rechts die Modellwechsel-Kommandos](images/cdx-installation_und_setup_05_unterstuetzte_modelle.png)
...
![Onboarding-Funnel der ersten Session: Install, cd, Auth, Permissions, Welcome-Screen, TUI-Prompt; mit Info-Boxen zu ~/.codex-Dateien, AGENTS.md-Precedence und codex-exec Headless-Modus](images/cdx-installation_und_setup_06_hello_world.png)
...
## 7. Kurz-Referenz: Sandbox & Approval (Details in [sicherheit_und_sandboxing](CDX-04-Sicherheit-und-Sandboxing))

![Sicherheits-Dashboard mit Dual-Matrix aus Sandbox-Werten (read-only, workspace-write, danger-full-access) und Approval-Werten (untrusted, on-request, on-failure, never); Convenience-Flag full-auto hervorgehoben](images/cdx-installation_und_setup_07_kurz_referenz_sandbox_approval.png)
