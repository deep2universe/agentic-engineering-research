---
title: "04 Sicherheit und Sandboxing"
parent: "Codex CLI"
nav_order: 5
---
...
![Matrix aus Sandbox-Modi und Approval-Policies mit typischen Einsätzen, --full-auto und --yolo farblich markiert](images/cdx-sicherheit_01_approval_sandbox_matrix.png)
...
![Drei Plattform-Säulen (macOS Seatbelt, Linux Landlock+seccomp+bwrap, Windows AppContainer) mit Kernel als zentralem Schutzschild](images/cdx-sicherheit_02_kernel_sandbox.png)
...
![Trust-Flow als Türsteher-Metapher: Erster Start öffnet Trust-Dialog, verzweigt in trusted oder untrusted mit persistenter Ablage in config.toml](images/cdx-sicherheit_03_workspace_trust.png)
...
![Drei Siegel für Secret-Handling: shell_environment_policy, .env-Disziplin, disable_response_storage/ZDR](images/cdx-sicherheit_04_umgang_geheimnisse.png)
...
![Vier Angriffsvektoren (Repo-Dateien, Dependencies, Issues/PRs, Third-Party-MCP) prallen auf Festung, rechts die Prüfkette der sechs Mitigationen](images/cdx-sicherheit_05_prompt_injection.png)
...
![Governance-Pyramide mit Admin-Konsole, Managed Policies, Data-Usage, Cloud-Workspaces plus Organigramm vom Org-Admin bis zum Developer](images/cdx-sicherheit_06_enterprise_governance.png)
...
![CI-Pipeline mit Schleusen: Checkout, OIDC-Auth, Sandbox read-only, codex exec, Post-Action; rechts Minimal-YAML-Snippet](images/cdx-sicherheit_07_sichere_cicd.png)
...
![Drei Risiko-Profile als Ampel: review (grün, read-only), daily (gelb, workspace-write), yolo (rot, danger-full-access)](images/cdx-sicherheit_08_profile_risiko.png)
...
![Cockpit-Pre-Flight-Dashboard mit sieben grünen Indikatoren neben dem grossen roten --full-auto-Knopf](images/cdx-sicherheit_09_risiko_checkliste.png)
...
![Side-by-side-Vergleich Codex CLI vs. Claude Code über fünf Aspekte: Sandbox, Approval-Modell, Hook-System, Konfig-Ort, Governance](images/cdx-sicherheit_10_vergleich_claude.png)
