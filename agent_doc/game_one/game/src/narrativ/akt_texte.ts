...
export const AKT_TEXTE: readonly AktText[] = [
  {
    ...
    schlusssatz: 'Vierundzwanzig Vorgänge sind ausgeliefert. Gefragt hat niemand, wie. Das bleibt noch eine Weile so.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Der teure Weg steht noch. Er ist nur nicht mehr der einzige.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Der graue Kasten rechnet weiter. Er hat noch nie erklärt, wie er darauf kommt.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Der Stapel liegt noch da. Zwei Zentimeter Papier für einen einzigen Vorgang.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Zweihundert Abschnitte, eine Bewertung, ein Freitag. Die Rechnung kam am Montag.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Achtundachtzig Prozent Güte. Der Prüfer war sich bei neunzig Prozent davon sehr sicher.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Die Rolle liegt noch im Flur. Sie ist jetzt vier Meter kürzer und wird gelesen.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Die Kreidelinie ist verwischt. Die Mauer steht jetzt an zwei Stellen, und beide messen mit.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Er hat aufgehört, dich zu duzen. Gesagt hat er dazu nichts, und du hast es trotzdem gehört.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Er hat sich nichts notiert. Am Ende hat er sein eigenes Notizbuch auf dem Tisch liegen lassen.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Die Halle hat über Nacht dein Ziel erfüllt. Sie hat dabei genau das getan, was du gemessen hast.',
    monolith:
  ...
  },
  {
    ...
    schlusssatz: 'Neun Module tragen jetzt Namen. Eines davon ist er, im Maßstab der Aufgabe, und das genügt.',
    monolith:
