---
title: "03 Agentic Engineering Workflows"
...
![Mehrwert-Kaskade agentic Engineering bei PL/I](images/ptj-agentic_mehrwert_pl1.png)
...
![Die acht Phasen im agentic Workflow](images/ptj-acht_phasen_workflow.png)
...
![PL/I Understanding Agent Architektur](images/ptj-understanding_agent_architektur.png)
...
![Agentic Testing-Workflow](images/ptj-agentic_testing_workflow.png)
...
![Sieben Human-in-the-Loop-Regeln](images/ptj-hitl_regeln_pl1.png)
...
![Tooling-Landschaft jenseits von AWS](images/ptj-tooling_jenseits_aws.png)
...
![Quellen-Cluster fuer Dokument 4](images/ptj-referenzen_agentic_quellen.png)

*Sechs Quellen-Cluster um [_quellen](PTJ-Quellen) herum: Amazon Bedrock + AgentCore, Agentic AI Patterns, HITL Patterns, Dual-Run &amp; Testing, AWS Transform Specifics, Third-Party-Tooling. Zusammen ~60 oeffentliche Quellen ueber 17 Suchstring-Gruppen.*
