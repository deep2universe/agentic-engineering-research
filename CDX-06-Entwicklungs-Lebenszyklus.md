---
title: "06 Entwicklungs-Lebenszyklus"
parent: "Codex CLI"
nav_order: 7
---
...
![Übersicht der 10 Codex-CLI-Lebenszyklus-Phasen als Ringfluss mit Codex-Feature und Modus](images/cdx-lebenszyklus_00_uebersicht_phasen.png)
...
![Phase 1 — Reissbrett mit Plan-Prompt, Spec-Driven Development via GitHub Spec Kit und Kiro-for-Codex, Best Practices und Anti-Patterns](images/cdx-lebenszyklus_01_idee_spec.png)
...
![Phase 2 — Bauwerk-Fundament mit /init, AGENTS.md, Skills, Devcontainer und Trust-Level](images/cdx-lebenszyklus_02_projekt_setup.png)
...
![Phase 3 — Architekten-Plan mit Plan-Mode, ADR-Skill, Mermaid-Diagrammen und persistenten Task-Listen](images/cdx-lebenszyklus_03_design_planung.png)
...
![Phase 4 — Manufaktur-Werkbank mit Ticket-Style-Prompts, TDD-Loop, Sandbox workspace-write, /diff vor Akzeptanz und /compact](images/cdx-lebenszyklus_04_implementierung.png)
...
- **Ticket-Style-Prompts**: klarer Goal, Constraints, Definition of Done (siehe [praktische_workflows](CDX-07-Praktische-Workflows)).
...
![Phase 5 — Labor mit Codex-Selbsttest in der Sandbox, Playwright-MCP, respx/vcr, Coverage-Gate, Flake-Resolver und Property-Based Tests](images/cdx-lebenszyklus_05_testen_verifikation.png)
...
![Phase 6 — Lupe und Vier-Augen-Prinzip: lokal /review, Codex GitHub App, Lint/Format, Security-Prompt-Template, Two-Agent-Review](images/cdx-lebenszyklus_06_review_qualitaet.png)
...
![Phase 7 — Living Documentation als lebendiges Buch mit README-First, OpenAPI/TSDoc/Sphinx/mdBook und docs_sync-Skill](images/cdx-lebenszyklus_07_dokumentation.png)
...
![Phase 8 — Frachtschiff mit Release-Skill, Autofix-Job, gepinntem Docker-Template, Canary/Blue-Green und SBOM via syft+cosign](images/cdx-lebenszyklus_08_deployment_release.png)
...
**CI-Pattern (GitHub Actions, siehe [integrationen_ide_ci_cd](CDX-05-Integrationen-IDE-CI-CD) §4)**:
...
![Phase 9 — Notfall-Cockpit mit Sentry/Grafana-MCP, Hotfix-Profil, Postmortem-Skill mit 5-Whys und On-Call-Runbooks](images/cdx-lebenszyklus_09_betrieb_incident.png)
...
![Phase 10 — Werkstatt mit Repo-Exploration, Dependency-Audit, Cloud-Handoff für Multi-Hour-Tasks, Frozen-Lock und Feature-Flag-Gate](images/cdx-lebenszyklus_10_wartung_migration.png)
...
![Meta — 10 Prinzipien als Säulen-Tempel mit Hexagon-Karten und Leitlinien-Kompass](images/cdx-lebenszyklus_meta_10_prinzipien.png)
...
![Multi-Agent — vier Muster: Codex-Client+MCP-Server, Codex+Claude Code, Issue-Bot und Swarm](images/cdx-lebenszyklus_multi_agent.png)
...
![Greenfield-Roadmap als Kalender-Sprint von Day 0 Idee über Bootstrap, Implementation, Deployment, Betrieb bis zur quartalsweisen Wartung](images/cdx-lebenszyklus_skizze_greenfield.png)
