...
![Function Calling — Ablauf](images/aep-06_function_calling_flow.png)
...
![MCP Architektur — Standardisiertes Tool-Ökosystem](images/aep-06_mcp_architektur.png)
...
![Context Engineering — 4 Kerntechniken](images/aep-06_context_engineering.png)
...
![Memory-Typen — Von kurzfristig bis langfristig](images/aep-06_memory_typen.png)
