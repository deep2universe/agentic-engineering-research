---
title: "07 Erweiterter Loesungshorizont"
...
![Die sieben Rs plus zwei inoffizielle](images/ptj-sieben_rs_pl1.png)
...
![Alternative Tool-Oekosysteme](images/ptj-alternative_tool_oekosysteme.png)
...
![Drei Hybrid-Strategien](images/ptj-hybrid_strategien.png)
...
![Methodische Ideen](images/ptj-methodische_ideen.png)
...
![Team- und Organisations-Ideen](images/ptj-team_organisation_ideen.png)
...
![Aussergewoehnliche technische Optionen](images/ptj-ausserge_technische_optionen.png)
...
![Budgetaere und finanzielle Ideen](images/ptj-budget_finanzielle_ideen.png)
...
![Was NICHT mehr zeitgemaess ist](images/ptj-nicht_zeitgemaess.png)
...
![Zehn Leitfragen fuer die Entscheidung](images/ptj-leitfragen_entscheidung.png)
...
![Zusammenfassung des Loesungshorizonts](images/ptj-zusammenfassung_loesungshorizont.png)
...
![Quellen-Cluster fuer Dokument 8](images/ptj-referenzen_loesungshorizont_quellen.png)

*Sechs Quellen-Cluster: 7 Rs &amp; Migration Strategy, Alternative Tools, Formal Methods, Fine-Tuning + Decision Rules, Finanzierung + Insurance, Team &amp; Knowledge. ~50 oeffentliche Quellen in [_quellen](PTJ-Quellen).*
