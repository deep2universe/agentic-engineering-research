...
![Drei Szenarien fuer 50-Prozent-Projekte](images/ptj-was_bedeutet_50_prozent.png)
...
![Szenario A — Bidirektionale Koexistenz](images/ptj-szenario_a_bidirektional_koexistenz.png)
...
![Szenario B — Domain-basierte Trennung](images/ptj-szenario_b_domain_trennung.png)
...
![Szenario C — Freeze-and-Catch-Up plus Hotfix-Lanes](images/ptj-szenario_c_transform_im_fluss.png)
...
![Test-Strategien fuer 50-Prozent-Projekte](images/ptj-test_strategien_50_prozent.png)
...
![Drei organisatorische Muster](images/ptj-organisatorische_muster.png)
...
![Rettungsplan ueber vier Wochen](images/ptj-rettungsplan_4_wochen.png)
...
![Fuenf Anti-Patterns fuer 50-Prozent-Projekte](images/ptj-anti_patterns_50_prozent.png)
...
![Quellen-Cluster fuer Dokument 5](images/ptj-referenzen_50_prozent_quellen.png)

*Sechs Quellen-Cluster rund um [_quellen](PTJ-Quellen): Koexistenz-Patterns, DDD &amp; Bounded Contexts, CDC + Daten-Sync, Shadow-Traffic &amp; Tests, Organisatorische Muster, Saga &amp; Compensation. ~40 oeffentliche Quellen.*
